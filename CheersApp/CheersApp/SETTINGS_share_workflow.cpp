...
ZOOM_SDK_NAMESPACE::SDKError CSDKShareSettingsWorkFlow::EnableAnnotateHardwareAcceleration(bool bEnable)
{
	...
	{
		ZOOM_SDK_NAMESPACE::SDKError err = ZOOM_SDK_NAMESPACE::SDKERR_SUCCESS;
		err = m_pShareSettingContext->EnableAnnotateHardwareAcceleration(bEnable);
		return err;
	}
	return ZOOM_SDK_NAMESPACE::SDKERR_UNINITIALIZE;
}
...
bool CSDKShareSettingsWorkFlow::IsAnnotateHardwareAcceleration()
{
	if (m_pShareSettingContext)
	{
		bool bChecked = m_pShareSettingContext->IsAnnotateHardwareAccelerationEnabled();
		return bChecked;
	}
	return false;
}
