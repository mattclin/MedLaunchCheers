...
public:
	...
	void DoAutoJoinAudioChkClick_settings(bool b);
...
protected:
	...
	CButtonUI* m_cAutoJoinAudio;
	CButtonUI* m_cAutoJoinAudio_false;
	CSDKAudioSettingsWorkFlow m_audioSettingsWorkFlow_settings;
...
public:
	...
	void DoAutoJoinAudioChkClick(int num);
...
protected:
	...
	CSDKSettingsUIMgr* m_parentFrame;
	//CButtonUI* m_chkAutoJoinAudio;
	//CButtonUI* m_chkAutoJoinAudio_false;
...
public:
	...
	void DoUseHardwareAccelerationAnnotationChkClick();
...
private:
	...
	CCheckBoxUI* m_chkUseHardwareAccelerationAnnotaion = NULL;
