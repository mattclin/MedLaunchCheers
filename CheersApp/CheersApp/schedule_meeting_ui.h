...
#include "resource.h"
#include "mess_info.h"
//#include "dial_in_country_ui.h" //EDIT: removed dial_in_country from files
#include <sstream>
...
public:
	...
	//void DoClickEditDialInCountryBtn(); //EDIT: removed dial_in_country from files
	void DoClickViewPublicListBtn();
	//void InitDialInCountry(); //EDIT: removed dial_in_country from files
	void DoSchedule();
	void DoEdit();
...
protected:
	...
	//CDialInCountryUIMgr* m_dial_in_country; //EDIT: removed dial_in_country from files
	...
	//CButtonUI* m_edit_dial_in_btn; ////EDIT: removed dial_in_country from files
