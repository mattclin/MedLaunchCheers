...
\newcommand{\commonheader}[2]{
    ...
    \header
        {\small{\textbf{EECS 376: Foundations of Computer Science}} \\ \footnotesize{\textbf{University of Michigan, Winter 2021}}}
        {#1}
        {#2}
...
\newcommand{\hwheader}{
    \commonheader
        ...
        {\small \textbf{Due at 9:00pm, \duedate\\(grace period through 10:59 pm)}}
}
...
\newcommand{\hwpreface}{
\noindent Problems marked with \textbf{E} are graded \textbf{partially} on effort, which
means that they are graded \textbf{in part} subjectively on the perceived effort you
put into them, rather than \textbf{solely} on correctness. Problems marked with a \
\textbf{G} are group problems.  A group of 1-3 students may work on these together and turn in one assignment for the entire group.  Each member listed should have made real contributions. The group problems will be turned in separately on gradescope. For bonus questions, we will not provide any insight during office hours or on Piazza, and we do not guarantee anything about the difficulty of these questions. We strongly encourage you
to typeset your solutions in \LaTeX. \vspace{1ex}\\
If you collaborated with someone on the \textbf{non}-group problems, you must state their names. You must write your own solution for such problems and may not look at any other student’s write-up.
}
% \newcommand{\hwpreface}{
